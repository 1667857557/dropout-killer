...
- Replaced in-sample residual variance in the factor engine with analytic leave-one-out residual MSE and added lower-truncated positive predictive draws for the default positive-conditional recovery target.
